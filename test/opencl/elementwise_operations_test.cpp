...
int main()
{
  ...
  bench_elementwise <double, ublas::basic_row_major<>, 10, 10> b2;

  ///testing row major complex float elementwise operations
  bench_elementwise <std::complex<float>, ublas::basic_row_major<>, 10, 10> b5;
  ...
  bench_elementwise <double, ublas::basic_column_major<>, 10, 10> b4;

  ///testing column major complex float elementwise operations
  bench_elementwise <std::complex<float>, ublas::basic_column_major<>, 10, 10> b7;
